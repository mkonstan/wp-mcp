...
function wpmcp_tools() {
    $tools = array();
    foreach (array('wpmcp_core_tools', 'wpmcp_content_tools', 'wpmcp_revision_tools', 'wpmcp_taxonomy_tools', 'wpmcp_media_tools', 'wpmcp_comment_tools', 'wpmcp_menu_tools') as $fn) {
